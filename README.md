...
# Need install frida-tools and adb has connected to device
frida-ps -Uai
```
- adb 进入安卓系统shell
```bash
...
## frida_multiple_unpinning.js (from https://gist.github.com/akabe1/5632cbc1cd49f0237cbd0a93bc8e4452)
```js
